...
import productoController from './graphql/producto.controller.js'
...
import FactoryCustomError from './classes/CustomError.class.js'
let error = new FactoryCustomError()
...
app.use(
    ...
    graphqlHTTP({
        ...
        rootValue: {
            obtenerProducto: productoController.obtenerProducto,
            obtenerProductos: productoController.obtenerProductos,
            createProduct: productoController.createProduct,
            delProduct: productoController.delProduct,
            updateProduct: productoController.updateProduct,
        },
        graphiql: true,
      })
    );
...
app.use((req,res) => {
    ...
    res.status(404).json(error.getErrorMsg(404))
});
