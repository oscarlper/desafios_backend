...
socket.on('server:username', userName => {
    document.querySelector('#userWelcome').innerHTML=userName
    document.querySelector('#buttonLogout').innerHTML=`<a href="/logout.html?username=${userName}" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">Logout</a>`
})